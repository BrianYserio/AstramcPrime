...
return [
   ...
   'citizenships' => [
        ...
        'Bosnian', 'Botswanan', 'Brazilian', 'British', 'Bruneian', 'Bulgarian', 'Burkinan',
        ...
        'Jordanian', 'Kazakhstani', 'Kenyan', 'Kiribati', 'Kuwaiti', 'Kyrgyzstani', 'Laotian',
        ...
        'Monegasque', 'Mongolian', 'Montenegrin', 'Moroccan', 'Mozambican', 'Namibian', 'Nauruan',
        ...
        'Rwandan', 'Saint Lucian', 'Salvadoran', 'Samoan', 'Sammarinese', 'Saudi Arabian',
        ...
        'Taiwanese', 'Tajikistani', 'Tanzanian', 'Thai', 'Togolese', 'Tongan', 'Trinidadian',
        'Tunisian', 'Turkish', 'Turkmen', 'Tuvaluan', 'Ugandan', 'Ukrainian', 'Uruguayan',
        'Uzbekistani', 'Vanuatuan', 'Vatican', 'Venezuelan', 'Vietnamese', 'Yemeni', 'Zambian', 'Zimbabwean'
   ],
