<x-app-layout title="AstraMC Trucks & Equipments">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <x-add-link href="{{ route('units.create') }}">
            <x-addIcon />
            Units
        </x-add-link>
            ...
            <table class="min-w-full text-sm" id="main-table">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        @foreach(['Unit ID.', 'Type', 'Model', 'Description', 'Promo Price', 'Area Head Discount', 'Manager Discount', 'Discount', 'Selling Price',  'show'] as $col)
